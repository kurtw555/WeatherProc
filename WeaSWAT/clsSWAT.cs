...
namespace WeaSWAT
{
    class clsSWAT
    {
        ...
        public clsSWAT(frmSWAT _fSWAT, IMap _map, string _wdmFile)
        {
            WDMFile = _wdmFile;
            appMap = _map;
            fSWAT = _fSWAT;
        ...
        private bool GetDictionaryOfDatasets()
        {
            ...
            try
            {
                ...
                foreach (atcTimeseries lDataSet in lwdm.DataSets)
                {
                    ...
                    fSWAT.WriteStatus("Reading attributes of " + sloc + ":" +
                    ...
                    if (SWATVars.Contains(svar) && tunit.Contains("Hour"))
                    {
        ...
        public bool AssignMetVariableByBasin()
        {
            ...
            try
            {
                ...
                foreach (KeyValuePair<int, CPoint> kv in BasinCentroid)
                {
                    ...
                    fSWAT.WriteStatus("Assigning met stations to selected location " + basin.ToString() + "(" +
        ...
        {
            fSWAT.statuslbl.Text = msg;
            fSWAT.statusStrip.Refresh();
        }
