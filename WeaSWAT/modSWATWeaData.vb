...
Module modSWATWeaData
    Private pModifiedData As atcTimeseriesGroup
    Private pListDSN As List(Of String)
    Public Sub WriteSwatMet(ByVal lMetWDMFile As String,
                            ByVal aSaveInFolder As String,
                            ByVal pDateStart As DateTime,
                            ByVal pDateEnd As DateTime,
                            ByVal aListDSN As List(Of String),
        ...
        If atcDataManager.OpenDataSource(lMetWDM, lMetWDMFile, Nothing) Then
