...
namespace WeaModel
{
    public class Markov
    {
        ...
        private SortedDictionary<DateTime, string> dseries = new SortedDictionary<DateTime, string>();
        ...
        public Markov(string _site, string _svar,
        ...
        private void CalculateHourlyProbabilities()
        {
            ...
            {
                ShowError("Error in calculating transitional probabilities of rainfall for site " + site +
                    "!", ex);
            }
        }
