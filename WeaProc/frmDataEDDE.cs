...
namespace NCEIData
{
    public partial class frmDataEDDE : Form
    {
        ...
        public frmDataEDDE(frmMain _fMain,SortedDictionary<string, List<string>> _dicSelectedVars,
            List<string> _lstSelectedVars, Dictionary<string, bool> _optVars, string _scen, string _path)
        {
            ...
            {
                //ok
                dictSiteVars.TryGetValue(kv.Key, out svar);
                Debug.WriteLine(kv.Key + "," + string.Join(",", svar));
            }
            svar = dictSelSites.Keys.ToList();
            Debug.WriteLine("Location = "+string.Join(",",svar));
#endif
    ...
    Debug.WriteLine(msg);
        ...
        {
            Debug.WriteLine("Items in List: "+ string.Join(",",aList));
        }
        ...
        private void zgvSeries_Load(object sender, EventArgs e)
        {
